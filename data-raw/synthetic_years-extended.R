...
options_sac <- water_year_indices %>%
  filter(location == 'Sacramento Valley', between(WY, 1920, 2000)) %>%
  pull(Index)

names(options_sac) <- 1920:2000
...
options_sj <- water_year_indices %>%
  filter(location == 'San Joaquin Valley', between(WY, 1920, 2000)) %>%
  pull(Index)

names(options_sj) <- 1920:2000
